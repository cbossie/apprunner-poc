...
WORKDIR /src
COPY ["aws-lambda-annotation.csproj", "aws-lambda-annotation/"]
RUN dotnet restore "aws-lambda-annotation/aws-lambda-annotation.csproj"

WORKDIR "/src/aws-lambda-annotation"
COPY . .
RUN dotnet build "aws-lambda-annotation.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "aws-lambda-annotation.csproj" \
...
Execute unit tests
```
cd "aws-lambda-annotation/test/aws-lambda-annotation.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "aws-lambda-annotation/src/aws-lambda-annotation"
